...
namespace Template
{
    ...
    public class CommandWords
    {
        ...
        private static Command[] _commandArray = { new GoCommand(), new InsertCommand(), new QuitCommand(), new ShoutCommand(), new BackCommand(), new PickupCommand(), new OpenCommand(), new InspectCommand(), new UnlockCommand() };
